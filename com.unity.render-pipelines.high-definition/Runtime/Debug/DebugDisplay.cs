...
namespace UnityEngine.Experimental.Rendering.HDPipeline
{
    ...
    public class DebugDisplaySettings
    {
        ...
        static GUIContent[] lightingFullScreenDebugStrings = null;
        static int[] lightingFullScreenDebugValues = null;
        static GUIContent[] renderingFullScreenDebugStrings = null;
        static int[] renderingFullScreenDebugValues = null;
        static GUIContent[] msaaSamplesDebugStrings = null;
        static int[] msaaSamplesDebugValues = null;

        static List<GUIContent> cameraNames = new List<GUIContent>();
        static GUIContent[] cameraNamesStrings = null;
        static int[] cameraNamesValues = null;
        ...
        {
            return cameraNamesStrings[data.debugCameraToFreeze].text;
        }
        ...
        public void RegisterLightingDebug()
        {
            ...
            list.Add(new DebugUI.EnumField { displayName = "Fullscreen Debug Mode", getter = () => (int)data.fullScreenDebugMode, setter = value => SetFullScreenDebugMode((FullScreenDebugMode)value), enumNames = lightingFullScreenDebugStrings, enumValues = lightingFullScreenDebugValues, onValueChanged = RefreshLightingDebug, getIndex = () => data.lightingFulscreenDebugModeEnumIndex, setIndex = value => data.lightingFulscreenDebugModeEnumIndex = value });
        ...
        public void RegisterRenderingDebug()
        {
            ...
            {
                new DebugUI.EnumField { displayName = "Fullscreen Debug Mode", getter = () => (int)data.fullScreenDebugMode, setter = value => data.fullScreenDebugMode = (FullScreenDebugMode)value, enumNames = renderingFullScreenDebugStrings, enumValues = renderingFullScreenDebugValues, getIndex = () => data.renderingFulscreenDebugModeEnumIndex, setIndex = value => data.renderingFulscreenDebugModeEnumIndex = value },
            ...
            widgetList.AddRange(new DebugUI.Widget[]
            {
                new DebugUI.EnumField { displayName = "MSAA Samples", getter = () => (int)data.msaaSamples, setter = value => data.msaaSamples = (MSAASamples)value, enumNames = msaaSamplesDebugStrings, enumValues = msaaSamplesDebugValues, getIndex = () => data.msaaSampleDebugModeEnumIndex, setIndex = value => data.msaaSampleDebugModeEnumIndex = value },
            });

            widgetList.AddRange(new DebugUI.Widget[]
            {
                    new DebugUI.EnumField { displayName = "Freeze Camera for culling", getter = () => data.debugCameraToFreeze, setter = value => data.debugCameraToFreeze = value, enumNames = cameraNamesStrings, enumValues = cameraNamesValues, getIndex = () => data.debugCameraToFreezeEnumIndex, setIndex = value => data.debugCameraToFreezeEnumIndex = value },
            });
